...
void CorrectingRotation::run()
{
  ...
  while(leftSign != 0 || rightSign != 0) {
    ...
    // モータにtargetSpeed値をセット
    controller.setLeftMotortargetSpeed(targetSpeed * leftSign);
    controller.setRightMotortargetSpeed(targetSpeed * rightSign);

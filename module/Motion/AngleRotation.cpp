...
AngleRotation::AngleRotation(int _angle, double _targetSpeed, bool _isClockwise)
  : angle(_angle), targetSpeed(_targetSpeed), isClockwise(_isClockwise)
{
}

void AngleRotation::run()
{

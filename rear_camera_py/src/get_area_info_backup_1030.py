    ...
    def get_area_info(self, isR=True) -> None:
        ...
        try:
            ...
            if not np.all(self.block_coordi_red == 0):
                color_5_img[:, self.block_coordi_red[0]
                    :self.block_coordi_red[0]+2] = Color.BLACK.value  # 開発用
                color_5_img[self.block_coordi_red[1]
                    :self.block_coordi_red[1]+2, :] = Color.BLACK.value  # 開発用
            ...
            if not np.all(self.block_coordi_blue[0] == 0):
                color_5_img[:, self.block_coordi_blue[0, 0]
                    :self.block_coordi_blue[0, 0]+2] = Color.BLUE.value  # 開発用
                color_5_img[self.block_coordi_blue[0, 1]
                    :self.block_coordi_blue[0, 1]+2, :] = Color.BLUE.value  # 開発用
            ...
            if not np.all(self.block_coordi_blue[1] == 0):
                color_5_img[:, self.block_coordi_blue[1, 0]
                    :self.block_coordi_blue[1, 0]+2] = Color.GREEN.value  # 開発用
                color_5_img[self.block_coordi_blue[1, 1]
                    :self.block_coordi_blue[1, 1]+2, :] = Color.GREEN.value  # 開発用
